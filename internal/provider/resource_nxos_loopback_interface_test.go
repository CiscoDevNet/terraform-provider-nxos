...
func TestAccNxosLoopbackInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_loopback_interface.test", "link_logging", "enable"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_loopback_interface.test", "vrf_dn", "sys/inst-default"))
