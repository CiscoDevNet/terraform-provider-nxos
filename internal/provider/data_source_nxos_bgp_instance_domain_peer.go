...
type dataSourceBGPInstanceDomainPeerType struct{}

func (t dataSourceBGPInstanceDomainPeerType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceBGPInstanceDomainPeerType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceBGPInstanceDomainPeer{
		provider: provider,
	}, diags
}

type dataSourceBGPInstanceDomainPeer struct {
	provider provider
}

func (d dataSourceBGPInstanceDomainPeer) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var config, state BGPInstanceDomainPeer
