...
```terraform
import {
  to = nxos_bgp_peer_address_family.example
  identity = {
    "asn" : "<asn>"
    "vrf" : "<vrf>"
    "address" : "<address>"
...
import {
  to = nxos_bgp_peer_address_family.example
  id = "<asn>,<vrf>,<address>,<address_family>"
}
```
...
```shell
terraform import nxos_bgp_peer_address_family.example "<asn>,<vrf>,<address>,<address_family>"
```
