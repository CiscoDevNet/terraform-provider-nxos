...
var _ datasource.DataSource = &DefaultQOSPolicyInterfaceInDataSource{}

func NewDefaultQOSPolicyInterfaceInDataSource() datasource.DataSource {
	return &DefaultQOSPolicyInterfaceInDataSource{}
}
...
func (d *DefaultQOSPolicyInterfaceInDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_default_qos_policy_interface_in"
}

func (d *DefaultQOSPolicyInterfaceInDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *DefaultQOSPolicyInterfaceInDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
