...
func TestAccNxosLoopbackInterfaceVRF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_loopback_interface_vrf.test", "interface_id", "lo123"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_loopback_interface_vrf.test", "vrf_dn", "sys/inst-default"))
