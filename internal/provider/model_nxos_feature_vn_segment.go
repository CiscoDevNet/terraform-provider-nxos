...
type FeatureVNSegmentIdentity struct {
	Device types.String `tfsdk:"device"`
}

func (data *FeatureVNSegmentIdentity) toIdentity(ctx context.Context, plan *FeatureVNSegment) {
...
func (data FeatureVNSegment) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureVNSegment) fromBody(res gjson.Result, all bool) {
...
func (data FeatureVNSegment) toDeleteBody() nxos.Body {
	body := ""
