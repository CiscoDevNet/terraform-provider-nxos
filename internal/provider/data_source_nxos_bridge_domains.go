...
func (d *BridgeDomainsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the bridge domain configuration on NX-OS devices, including VLAN and VXLAN encapsulation mappings.", "bdEntity", "Bridge%20Domain/bd:Entity/").AddAdditionalDocs([]string{"l2BD"}, []string{"Layer%202/l2:BD/"}).String,
