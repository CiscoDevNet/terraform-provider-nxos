...
description: |-
  ...
  API Documentation: pimSSMPatP https://pubhub.devnetcloud.com/media/dme-docs-10-3-1/docs/Layer%203/pim:SSMPatP/
  Parent resources
...
```shell
terraform import nxos_pim_ssm_policy.example "<vrf_name>"
```
