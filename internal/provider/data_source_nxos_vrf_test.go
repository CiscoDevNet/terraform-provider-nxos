...
func TestAccDataSourceNxosVRF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_vrf.test", "vrfs.VRF1.description", "My VRF1 Description"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_vrf.test", "vrfs.VRF1.admin_state", "admin-up"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_vrf.test", "vrfs.VRF1.controller_id", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_vrf.test", "vrfs.VRF1.encap", "vxlan-103901"))
