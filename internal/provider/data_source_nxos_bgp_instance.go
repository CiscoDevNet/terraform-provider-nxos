...
var _ datasource.DataSource = &BGPInstanceDataSource{}

func NewBGPInstanceDataSource() datasource.DataSource {
	return &BGPInstanceDataSource{}
}
...
func (d *BGPInstanceDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *BGPInstanceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
