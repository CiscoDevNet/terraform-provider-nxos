...
func (d *SSHDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the SSH configuration on NX-OS devices, including SSH server settings and SSH key configuration.").AddApiDocumentation("commEntity", "Communication/comm:Entity/", []string{"commSsh", "commSshKey"}, []string{"Communication/comm:Ssh/", "Communication/comm:SshKey/"}).String,
...
func (d *SSHDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	queries := []func(*nxos.Req){nxos.Query("rsp-subtree", "full"), nxos.Query("rsp-subtree-class", "commSsh,commSshKey")}
