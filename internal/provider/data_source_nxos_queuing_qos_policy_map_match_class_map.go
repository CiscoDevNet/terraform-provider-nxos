...
var (
	_ datasource.DataSource              = &QueuingQOSPolicyMapMatchClassMapDataSource{}
	_ datasource.DataSourceWithConfigure = &QueuingQOSPolicyMapMatchClassMapDataSource{}
)
...
func (d *QueuingQOSPolicyMapMatchClassMapDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config QueuingQOSPolicyMapMatchClassMap
