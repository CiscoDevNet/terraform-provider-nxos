...
var _ datasource.DataSource = &BGPPeerTemplateAddressFamilyDataSource{}

func NewBGPPeerTemplateAddressFamilyDataSource() datasource.DataSource {
	return &BGPPeerTemplateAddressFamilyDataSource{}
}
...
func (d *BGPPeerTemplateAddressFamilyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *BGPPeerTemplateAddressFamilyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
