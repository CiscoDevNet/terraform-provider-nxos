...
type BGPInstanceDomainPeerContainerAfMaxPrefix struct {
...
func (data BGPInstanceDomainPeerContainerAfMaxPrefix) getDn() string {
	return fmt.Sprintf("sys/bgp/inst/dom-[%s]/peercont-[%s]/af-[%s]/maxpfxp", data.Vrf_name.Value, data.Name.Value, data.Type.Value)
}

func (data BGPInstanceDomainPeerContainerAfMaxPrefix) getClassName() string {
	return "bgpMaxPfxP"
}

func (data BGPInstanceDomainPeerContainerAfMaxPrefix) toBody() nxos.Body {
	attrs := nxos.Body{}.
...
func (data *BGPInstanceDomainPeerContainerAfMaxPrefix) fromBody(res gjson.Result) {
...
func (data *BGPInstanceDomainPeerContainerAfMaxPrefix) fromPlan(plan BGPInstanceDomainPeerContainerAfMaxPrefix) {
