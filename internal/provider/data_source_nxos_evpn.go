...
func (d *EVPNDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the global EVPN configuration on NX-OS devices, including EVPN VNIs with route distinguisher and route target settings.").AddApiDocumentation("rtctrlL2Evpn", "Routing%20and%20Forwarding/rtctrl:L2Evpn/", []string{"rtctrlBDEvi", "rtctrlRttP", "rtctrlRttEntry"}, []string{"Routing%20and%20Forwarding/rtctrl:BDEvi/", "Routing%20and%20Forwarding/rtctrl:RttP/", "Routing%20and%20Forwarding/rtctrl:RttEntry/"}).String,
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"table_map": schema.StringAttribute{
							MarkdownDescription: "Route-map name for table-map command to filter routes.",
							Computed:            true,
						},
