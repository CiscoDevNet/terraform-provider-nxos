...
var _ datasource.DataSource = &PIMStaticRPGroupListDataSource{}
...
func (d *PIMStaticRPGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
