...
var (
	_ datasource.DataSource              = &RouteMapRuleDataSource{}
	_ datasource.DataSourceWithConfigure = &RouteMapRuleDataSource{}
)

func NewRouteMapRuleDataSource() datasource.DataSource {
	return &RouteMapRuleDataSource{}
}
...
func (d *RouteMapRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read a Route-Map Rule configuration.", "rtmapRule", "Routing%20and%20Forwarding/rtmap:Rule/").String,
