...
type OSPFv3InstanceIdentity struct {
	Device types.String `tfsdk:"device"`
	Name   types.String `tfsdk:"name"`
}

func (data *OSPFv3InstanceIdentity) toIdentity(ctx context.Context, plan *OSPFv3Instance) {
...
func (data *OSPFv3Instance) fromBody(res gjson.Result) {
	data.AdminState = types.StringValue(res.Get(data.getClassName() + ".attributes.adminSt").String())
	data.Name = types.StringValue(res.Get(data.getClassName() + ".attributes.name").String())
}

func (data *OSPFv3Instance) updateFromBody(res gjson.Result) {
...
func (data OSPFv3Instance) getDeleteDns() []string {
	dns := []string{}
