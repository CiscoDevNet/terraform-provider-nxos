...
func TestAccNxosFeatureSSH(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_feature_ssh.test", "admin_state", "enabled"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNxosFeatureSSHConfig_all(),
...
func testAccNxosFeatureSSHConfig_all() string {
	config := `resource "nxos_feature_ssh" "test" {` + "\n"
	config += `	admin_state = "enabled"` + "\n"
	config += `}` + "\n"
	return config
