		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.nxos_physical_interface.test", "access_vlan", "vlan-10"),
					...
					resource.TestCheckResourceAttr("data.nxos_physical_interface.test", "mode", "trunk"),
					resource.TestCheckResourceAttr("data.nxos_physical_interface.test", "mtu", "9216"),
					resource.TestCheckResourceAttr("data.nxos_physical_interface.test", "native_vlan", "vlan-10"),
					...
					resource.TestCheckResourceAttr("data.nxos_physical_interface.test", "trunk_vlans", "100-200,300"),
