...
var (
	_ datasource.DataSource              = &PortChannelInterfaceMemberDataSource{}
	_ datasource.DataSourceWithConfigure = &PortChannelInterfaceMemberDataSource{}
)

func NewPortChannelInterfaceMemberDataSource() datasource.DataSource {
	return &PortChannelInterfaceMemberDataSource{}
}
...
func (d *PortChannelInterfaceMemberDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the configuration of a port-channel interface member.", "pcRsMbrIfs", "Interfaces/pc:RsMbrIfs/").String,
...
func (d *PortChannelInterfaceMemberDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config PortChannelInterfaceMember
