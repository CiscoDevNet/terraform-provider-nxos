...
var _ datasource.DataSource = &BGPAddressFamilyDataSource{}

func NewBGPAddressFamilyDataSource() datasource.DataSource {
	return &BGPAddressFamilyDataSource{}
}
...
func (d *BGPAddressFamilyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
