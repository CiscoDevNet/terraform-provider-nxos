...
var _ datasource.DataSource = &IPv4InterfaceAddressDataSource{}
...
func (d *IPv4InterfaceAddressDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
