...
func (t resourceIPv4AccessListEntryType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"destination_port_1": {
				MarkdownDescription: helpers.NewAttributeDescription("First destination port number.").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
			},
			"destination_port_2": {
				MarkdownDescription: helpers.NewAttributeDescription("Second destination port number.").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
			},
			...
			"destination_port_mask": {
				MarkdownDescription: helpers.NewAttributeDescription("Destination port mask number.").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
			},
			...
			"source_port_1": {
				MarkdownDescription: helpers.NewAttributeDescription("First source port number.").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
			},
			"source_port_2": {
				MarkdownDescription: helpers.NewAttributeDescription("Second source port number.").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
			},
			...
			"source_port_mask": {
				MarkdownDescription: helpers.NewAttributeDescription("Source port mask number.").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
			},
