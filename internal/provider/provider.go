...
func (p *provider) GetResources(ctx context.Context) (map[string]tfsdk.ResourceType, diag.Diagnostics) {
	return map[string]tfsdk.ResourceType{
		...
		"nxos_bgp_instance_domain":                                  resourceBGPInstanceDomainType{},
		"nxos_bgp_instance_domain_af":                               resourceBGPInstanceDomainAfType{},
		"nxos_bgp_instance_domain_gracefulrestart":                  resourceBGPInstanceDomainGracefulRestartType{},
		"nxos_bgp_instance_domain_peer":                             resourceBGPInstanceDomainPeerType{},
		"nxos_bgp_instance_domain_peercontainer":                    resourceBGPInstanceDomainPeerContainerType{},
		"nxos_bgp_instance_domain_peercontainer_af":                 resourceBGPInstanceDomainPeerContainerAfType{},
		"nxos_bgp_instance_domain_peercontainer_af_maxprefix":       resourceBGPInstanceDomainPeerContainerAfMaxPrefixType{},
...
func (p *provider) GetDataSources(ctx context.Context) (map[string]tfsdk.DataSourceType, diag.Diagnostics) {
	return map[string]tfsdk.DataSourceType{
		...
		"nxos_bgp_instance_domain":                                  dataSourceBGPInstanceDomainType{},
		"nxos_bgp_instance_domain_af":                               dataSourceBGPInstanceDomainAfType{},
		"nxos_bgp_instance_domain_gracefulrestart":                  dataSourceBGPInstanceDomainGracefulRestartType{},
		"nxos_bgp_instance_domain_peer":                             dataSourceBGPInstanceDomainPeerType{},
		"nxos_bgp_instance_domain_peercontainer":                    dataSourceBGPInstanceDomainPeerContainerType{},
		"nxos_bgp_instance_domain_peercontainer_af":                 dataSourceBGPInstanceDomainPeerContainerAfType{},
		"nxos_bgp_instance_domain_peercontainer_af_maxprefix":       dataSourceBGPInstanceDomainPeerContainerAfMaxPrefixType{},
