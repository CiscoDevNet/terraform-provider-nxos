	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"password_encryption_admin_state": schema.StringAttribute{
				MarkdownDescription: "The administrative state of the AES password encryption feature.",
				Computed:            true,
			},
			"password_encryption_use_tam": schema.StringAttribute{
				MarkdownDescription: "Use Trust Anchor Module (TAM) for password encryption.",
				Computed:            true,
			},
