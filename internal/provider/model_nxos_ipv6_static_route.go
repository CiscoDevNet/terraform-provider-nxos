...
func (data IPv6StaticRoute) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *IPv6StaticRoute) fromBody(res gjson.Result, all bool) {
...
func (data *IPv6StaticRoute) getIdsFromDn() {
	reString := strings.ReplaceAll("sys/ipv6/inst/dom-[%s]/rt-[%s]", "%[1]s", ".+")
