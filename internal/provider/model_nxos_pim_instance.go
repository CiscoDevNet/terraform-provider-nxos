...
func (data PIMInstance) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *PIMInstance) updateFromBody(res gjson.Result) {
...
func (data PIMInstance) getDeleteDns() []string {
	dns := []string{}
