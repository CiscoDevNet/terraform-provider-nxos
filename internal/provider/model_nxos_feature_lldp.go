...
func (data FeatureLLDP) toBody(update bool) nxos.Body {
	body := ""
...
func (data *FeatureLLDP) fromBody(res gjson.Result, all bool) {
...
func (data FeatureLLDP) toDeleteBody() nxos.Body {
	body := ""
