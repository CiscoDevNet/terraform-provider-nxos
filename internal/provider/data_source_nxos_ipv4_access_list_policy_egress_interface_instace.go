...
var _ datasource.DataSource = &IPv4AccessListPolicyEgressInterfaceInstaceDataSource{}
...
func (d *IPv4AccessListPolicyEgressInterfaceInstaceDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *IPv4AccessListPolicyEgressInterfaceInstaceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
