...
```bash
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-nxos/main/sbom/latest/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-nxos/main/sbom/latest/sbom.cyclonedx.json
```

### Specific Versions
Each release has its own directory:
- `sbom/v0.5.10/sbom.spdx.json`
- `sbom/v0.5.10/sbom.cyclonedx.json`

**Download Example:**
```bash
# Replace VERSION with the desired release version
VERSION=v0.5.10
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-nxos/main/sbom/${VERSION}/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-nxos/main/sbom/${VERSION}/sbom.cyclonedx.json
```

### Browse All Versions
View the complete SBOM history in the repository:
https://github.com/CiscoDevNet/terraform-provider-nxos/tree/main/sbom
...
```bash
# SPDX format
jq '.packages[] | select(.name != "terraform-provider-nxos") | {name, version}' sbom/latest/sbom.spdx.json
...
git diff v0.5.9 v0.5.10 -- sbom/latest/sbom.spdx.json
```
...
```bash
# Clone repository
git clone https://github.com/CiscoDevNet/terraform-provider-nxos.git
cd terraform-provider-nxos
...
If you have questions about SBOM usage or find issues with the generated SBOMs, please [open an issue](https://github.com/CiscoDevNet/terraform-provider-nxos/issues) with the `sbom` label.
