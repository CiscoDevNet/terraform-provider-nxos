...
type resourceBGPInstanceDomainAfType struct{}

func (t resourceBGPInstanceDomainAfType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewResourceDescription("This resource can manage the BGP (VRF) address family configuration.", "bgpGr", "Routing%20and%20Forwarding/bgp:DomAf/").AddParents("bgp_instance_domain").String,
...
func (t resourceBGPInstanceDomainAfType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceBGPInstanceDomainAf{
		provider: provider,
	}, diags
}

type resourceBGPInstanceDomainAf struct {
	provider provider
}

func (r resourceBGPInstanceDomainAf) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state BGPInstanceDomainAf
...
func (r resourceBGPInstanceDomainAf) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state BGPInstanceDomainAf
...
func (r resourceBGPInstanceDomainAf) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state BGPInstanceDomainAf
...
func (r resourceBGPInstanceDomainAf) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state BGPInstanceDomainAf
...
func (r resourceBGPInstanceDomainAf) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
