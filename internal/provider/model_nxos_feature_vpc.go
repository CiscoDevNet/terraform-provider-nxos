...
type FeatureVPCIdentity struct {
	Device types.String `tfsdk:"device"`
}
...
func (data FeatureVPC) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureVPC) fromBody(res gjson.Result) {
	data.AdminState = types.StringValue(res.Get(data.getClassName() + ".attributes.adminSt").String())
}

func (data *FeatureVPC) updateFromBody(res gjson.Result) {
...
func (data FeatureVPC) toDeleteBody() nxos.Body {
	body := ""
