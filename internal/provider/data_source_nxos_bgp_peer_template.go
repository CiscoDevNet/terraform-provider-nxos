...
type dataSourceBGPPeerTemplateType struct{}

func (t dataSourceBGPPeerTemplateType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceBGPPeerTemplateType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceBGPPeerTemplate{
		provider: provider,
	}, diags
}

type dataSourceBGPPeerTemplate struct {
	provider provider
}

func (d dataSourceBGPPeerTemplate) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var config, state BGPPeerTemplate
