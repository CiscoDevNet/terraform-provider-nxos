...
func TestAccDataSourceNxosTacacs(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceNxosTacacsPrerequisitesConfig + testAccDataSourceNxosTacacsConfig,
...
const testAccDataSourceNxosTacacsPrerequisitesConfig = `
...
const testAccDataSourceNxosTacacsConfig = `
...
data "nxos_tacacs" "test" {
  depends_on = [nxos_tacacs.test]
}
`
