...
type FeaturePIMIdentity struct {
	Device types.String `tfsdk:"device"`
}
...
func (data *FeaturePIM) updateFromBody(res gjson.Result) {
...
func (data FeaturePIM) toDeleteBody() nxos.Body {
	body := ""
...
func (data FeaturePIM) getDeleteDns() []string {
	dns := []string{}
