...
func (data FeatureTACACS) getClassName() string {
	return "fmTacacsplus"
}

func (data FeatureTACACS) toBody(update bool) nxos.Body {
	body := ""
...
func (data *FeatureTACACS) fromBody(res gjson.Result, all bool) {
