...
func TestAccDataSourceNxosSVIInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "autostate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "bandwidth", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "carrier_delay", "200"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "inband_management", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "load_interval_counter_1", "90"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "load_interval_counter_2", "120"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "load_interval_counter_3", "90"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "mac_address", "00:25:B5:00:00:01"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "mtu_inherit", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_svi_interface.test", "snmp_trap_link_status", "false"))
