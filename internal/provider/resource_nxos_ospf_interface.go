	...
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"advertise_secondaries": {
				MarkdownDescription: helpers.NewDescription("Advertise secondary IP addresses.").AddDefaultValueDescription("true").String,
				Type:                types.BoolType,
				Optional:            true,
				Computed:            true,
				PlanModifiers: tfsdk.AttributePlanModifiers{
			...
			"bfd": {
				MarkdownDescription: helpers.NewDescription("Bidirectional Forwarding Detection (BFD).").AddDefaultValueDescription("unspecified").String,
				Type:                types.StringType,
				Optional:            true,
				Computed:            true,
				PlanModifiers: tfsdk.AttributePlanModifiers{
			...
			"cost": {
				MarkdownDescription: helpers.NewDescription("Specifies the cost of interface.").AddIntegerRangeDescription(0, 65535).AddDefaultValueDescription("0").String,
			...
			"dead_interval": {
				MarkdownDescription: helpers.NewDescription("Dead interval, interval after which router declares that neighbor as down.").AddIntegerRangeDescription(0, 65535).AddDefaultValueDescription("0").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
				Validators: []tfsdk.AttributeValidator{
			...
			"hello_interval": {
				MarkdownDescription: helpers.NewDescription("Hello interval, interval between hello packets that OSPF sends on the interface.").AddIntegerRangeDescription(0, 65535).AddDefaultValueDescription("10").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
				Validators: []tfsdk.AttributeValidator{
			...
			"network_type": {
				MarkdownDescription: helpers.NewDescription("Network type.").AddDefaultValueDescription("unspecified").String,
				Type:                types.StringType,
				Optional:            true,
				Computed:            true,
				PlanModifiers: tfsdk.AttributePlanModifiers{
			...
			"passive": {
				MarkdownDescription: helpers.NewDescription("Passive interface control. Interface can be configured as passive or non-passive.").AddDefaultValueDescription("unspecified").String,
				Type:                types.StringType,
				Optional:            true,
				Computed:            true,
				PlanModifiers: tfsdk.AttributePlanModifiers{
			...
			"priority": {
				MarkdownDescription: helpers.NewDescription("Priority, used in determining the designated router on this network.").AddIntegerRangeDescription(0, 255).AddDefaultValueDescription("1").String,
				Type:                types.Int64Type,
				Optional:            true,
				Computed:            true,
				Validators: []tfsdk.AttributeValidator{
