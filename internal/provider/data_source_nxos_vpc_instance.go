...
var (
	_ datasource.DataSource              = &VPCInstanceDataSource{}
	_ datasource.DataSourceWithConfigure = &VPCInstanceDataSource{}
)

func NewVPCInstanceDataSource() datasource.DataSource {
	return &VPCInstanceDataSource{}
}
...
func (d *VPCInstanceDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_vpc_instance"
}
...
func (d *VPCInstanceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the vPC instance configuration.", "vpcInst", "System/vpc:Inst/").String,
