...
type resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroupType struct{}
...
func (t resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroupType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup{
		provider: provider,
	}, diags
}

type resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup struct {
	provider provider
}

func (r resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
...
func (r resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state DefaultQOSPolicyMapMatchClassMapSetQOSGroup
...
func (r resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state DefaultQOSPolicyMapMatchClassMapSetQOSGroup
...
func (r resourceDefaultQOSPolicyMapMatchClassMapSetQOSGroup) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
