...
var (
	_ datasource.DataSource              = &NVEVNIIngressReplicationDataSource{}
	_ datasource.DataSourceWithConfigure = &NVEVNIIngressReplicationDataSource{}
)
...
func (d *NVEVNIIngressReplicationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config NVEVNIIngressReplication
