...
type FeatureNgMVPNIdentity struct {
	Device types.String `tfsdk:"device"`
}
...
func (data FeatureNgMVPN) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureNgMVPN) fromBody(res gjson.Result) {
	data.AdminState = types.StringValue(res.Get(data.getClassName() + ".attributes.adminSt").String())
}

func (data *FeatureNgMVPN) updateFromBody(res gjson.Result) {
