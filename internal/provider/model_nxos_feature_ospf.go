...
type FeatureOSPFIdentity struct {
	Device types.String `tfsdk:"device"`
}
...
func (data FeatureOSPF) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureOSPF) updateFromBody(res gjson.Result) {
...
func (data FeatureOSPF) toDeleteBody() nxos.Body {
	body := ""
...
func (data FeatureOSPF) getDeleteDns() []string {
	dns := []string{}
