...
type dataSourceISISInterfaceType struct{}

func (t dataSourceISISInterfaceType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceISISInterfaceType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceISISInterface{
		provider: provider,
	}, diags
}

type dataSourceISISInterface struct {
	provider provider
}

func (d dataSourceISISInterface) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
