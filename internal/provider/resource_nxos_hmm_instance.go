...
func (t resourceHMMInstanceType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This resource can manage the HMM Fabric Forwarding Instance configuration.", "hmmFwdInst", "Host%20Mobility/hmm:FwdInst/").String,
