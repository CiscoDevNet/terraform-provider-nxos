...
var _ datasource.DataSource = &EVPNVNIRouteTargetDirectionDataSource{}
...
func (d *EVPNVNIRouteTargetDirectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *EVPNVNIRouteTargetDirectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
