...
type resourceQueuingQOSPolicyMapType struct{}
...
func (t resourceQueuingQOSPolicyMapType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceQueuingQOSPolicyMap{
		provider: provider,
	}, diags
}

type resourceQueuingQOSPolicyMap struct {
	provider provider
}

func (r resourceQueuingQOSPolicyMap) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
...
func (r resourceQueuingQOSPolicyMap) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourceQueuingQOSPolicyMap) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state QueuingQOSPolicyMap
...
func (r resourceQueuingQOSPolicyMap) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state QueuingQOSPolicyMap
...
func (r resourceQueuingQOSPolicyMap) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
