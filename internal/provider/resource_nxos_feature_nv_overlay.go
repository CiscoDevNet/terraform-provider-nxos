...
var _ resource.ResourceWithImportState = &FeatureNVOverlayResource{}
...
func (r *FeatureNVOverlayResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
