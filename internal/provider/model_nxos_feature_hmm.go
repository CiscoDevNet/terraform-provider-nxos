...
type FeatureHMMIdentity struct {
	Device types.String `tfsdk:"device"`
}

func (data *FeatureHMMIdentity) toIdentity(ctx context.Context, plan *FeatureHMM) {
...
func (data *FeatureHMM) updateFromBody(res gjson.Result) {
...
func (data FeatureHMM) toDeleteBody() nxos.Body {
	body := ""
...
func (data FeatureHMM) getDeleteDns() []string {
	dns := []string{}
