...
var (
	_ datasource.DataSource              = &DefaultQOSPolicyMapMatchClassMapSetQOSGroupDataSource{}
	_ datasource.DataSourceWithConfigure = &DefaultQOSPolicyMapMatchClassMapSetQOSGroupDataSource{}
)
...
func (d *DefaultQOSPolicyMapMatchClassMapSetQOSGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DefaultQOSPolicyMapMatchClassMapSetQOSGroup
