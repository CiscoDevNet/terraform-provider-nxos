...
type resourceBGPInstanceDomainPeerContainerAfType struct{}

func (t resourceBGPInstanceDomainPeerContainerAfType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewResourceDescription("This resource can manage the BGP peer template address family configuration.", "bgpPeerAf", "Routing%20and%20Forwarding/bgp:PeerAf/").AddParents("bgp_instance_domain_peercontainer").AddChildren("bgp_instance_domain_peercontainer_af_maxprefix").String,
...
func (t resourceBGPInstanceDomainPeerContainerAfType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceBGPInstanceDomainPeerContainerAf{
		provider: provider,
	}, diags
}

type resourceBGPInstanceDomainPeerContainerAf struct {
	provider provider
}

func (r resourceBGPInstanceDomainPeerContainerAf) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state BGPInstanceDomainPeerContainerAf
...
func (r resourceBGPInstanceDomainPeerContainerAf) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state BGPInstanceDomainPeerContainerAf
...
func (r resourceBGPInstanceDomainPeerContainerAf) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state BGPInstanceDomainPeerContainerAf
...
func (r resourceBGPInstanceDomainPeerContainerAf) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state BGPInstanceDomainPeerContainerAf
...
func (r resourceBGPInstanceDomainPeerContainerAf) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
