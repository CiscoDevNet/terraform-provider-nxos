...
var _ datasource.DataSource = &ISISInterfaceDataSource{}
...
func (d *ISISInterfaceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
