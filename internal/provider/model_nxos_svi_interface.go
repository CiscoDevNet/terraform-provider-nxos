...
type SVIInterface struct {
	...
	SviInterfaces map[string]SVIInterfaceSviInterfaces `tfsdk:"svi_interfaces"`
}
...
func (data SVIInterfaceSviInterfaces) getRn(key string) string {
...
func (data SVIInterface) toBody(config SVIInterface) nxos.Body {
	body := ""
			...
			v.ForEach(
				func(classname, value gjson.Result) bool {
					if classname.String() == "sviIf" {
						var child SVIInterfaceSviInterfaces
