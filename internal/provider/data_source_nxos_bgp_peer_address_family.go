...
type dataSourceBGPPeerAddressFamilyType struct{}

func (t dataSourceBGPPeerAddressFamilyType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceBGPPeerAddressFamilyType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceBGPPeerAddressFamily{
		provider: provider,
	}, diags
}

type dataSourceBGPPeerAddressFamily struct {
	provider provider
}

func (d dataSourceBGPPeerAddressFamily) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
