...
var _ datasource.DataSource = &PIMInterfaceDataSource{}
...
func (d *PIMInterfaceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
