...
var _ datasource.DataSource = &QueuingQOSPolicyMapDataSource{}
...
func (d *QueuingQOSPolicyMapDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_queuing_qos_policy_map"
}

func (d *QueuingQOSPolicyMapDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *QueuingQOSPolicyMapDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
