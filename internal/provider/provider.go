...
func (p *NxosProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewQueuingQoSResource,
		NewRoutePolicyResource,
		NewSpanningTreeResource,
		NewSubinterfacesResource,
...
func (p *NxosProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewLoopbackInterfacesDataSource,
		NewNTPDataSource,
		NewNVODataSource,
		NewOSPFDataSource,
		NewOSPFv3DataSource,
		NewPhysicalInterfacesDataSource,
		NewPIMDataSource,
		NewPortChannelInterfacesDataSource,
		NewQueuingQoSDataSource,
		NewRoutePolicyDataSource,
		NewSpanningTreeDataSource,
		NewSubinterfacesDataSource,
		NewSVIInterfacesDataSource,
		NewSystemDataSource,
