...
var _ datasource.DataSource = &QueuingQOSPolicyMapMatchClassMapRemainingBandwidthDataSource{}

func NewQueuingQOSPolicyMapMatchClassMapRemainingBandwidthDataSource() datasource.DataSource {
	return &QueuingQOSPolicyMapMatchClassMapRemainingBandwidthDataSource{}
}
...
func (d *QueuingQOSPolicyMapMatchClassMapRemainingBandwidthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *QueuingQOSPolicyMapMatchClassMapRemainingBandwidthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
