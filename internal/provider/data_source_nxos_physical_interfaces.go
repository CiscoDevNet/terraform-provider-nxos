...
var (
	_ datasource.DataSource              = &PhysicalInterfacesDataSource{}
	_ datasource.DataSourceWithConfigure = &PhysicalInterfacesDataSource{}
)

func NewPhysicalInterfacesDataSource() datasource.DataSource {
	return &PhysicalInterfacesDataSource{}
}

type PhysicalInterfacesDataSource struct {
	data *NxosProviderData
}

func (d *PhysicalInterfacesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_physical_interfaces"
}

func (d *PhysicalInterfacesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the configuration of physical interfaces on NX-OS devices, including settings such as speed, duplex, MTU, switchport mode, and VLAN assignments.", "interfaceEntity", "Interfaces/interface:Entity/").AddAdditionalDocs([]string{"l1PhysIf", "nwRtVrfMbr"}, []string{"System/l1:PhysIf/", "Routing%20and%20Forwarding/nw:RtVrfMbr/"}).String,
...
func (d *PhysicalInterfacesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *PhysicalInterfacesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
