...
type IPv4StaticRouteIdentity struct {
	Device  types.String `tfsdk:"device"`
	VrfName types.String `tfsdk:"vrf_name"`
	Prefix  types.String `tfsdk:"prefix"`
}
...
func (data *IPv4StaticRoute) fromIdentity(ctx context.Context, identity *IPv4StaticRouteIdentity) {
...
func (data IPv4StaticRoute) toBody() nxos.Body {
	...
	for _, child := range data.NextHops {
		...
		body, _ = sjson.SetRaw(body, childrenPath+".-1.ipv4Nexthop.attributes", attrs)
	}
