...
var _ datasource.DataSource = &BGPPeerTemplateDataSource{}
...
func (d *BGPPeerTemplateDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
