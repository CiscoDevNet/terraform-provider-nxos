...
- [srcintfEntity](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/System/srcintf:Entity/)
- [srcintfSsh](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/System/srcintf:Ssh/)
- [srcintfFtp](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/System/srcintf:Ftp/)
- [smartcardPasswdEncrypt](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Security and Policing/smartcard:PasswdEncrypt/)
- [acllogEntity](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Security and Policing/acllog:Entity/)
- [acllogInst](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Security and Policing/acllog:Inst/)
...
- [pvlanPrivateVlan](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:PrivateVlan/)
- [pvlanVlan](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:Vlan/)
- [pvlanIf](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:If/)
- [pvlanAccess](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:Access/)
- [pvlanAccessPromiscuous](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:AccessPromiscuous/)
- [pvlanAccessSecondary](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:AccessSecondary/)
- [pvlanTrunk](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:Trunk/)
- [pvlanTrunkPromiscuousTable](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:TrunkPromiscuousTable/)
- [pvlanTrunkPromiscuousEntry](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:TrunkPromiscuousEntry/)
- [pvlanTrunkSecondaryTable](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:TrunkSecondaryTable/)
- [pvlanTrunkSecondaryEntry](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:TrunkSecondaryEntry/)
- [pvlanSvi](https://pubhub.devnetcloud.com/media/dme-docs-10-5-3/docs/Layer%202/pvlan:Svi/)
...
- `acl_log_detailed` (Boolean) Include detailed ACL information.
- `acl_log_entries` (Number) Maximum number of flows to be monitored by logging process.
  - Range: `0`-`1048576`
- `acl_log_include_mac` (Boolean) Include Mac info in syslogs.
- `acl_log_include_sgt` (Boolean) Include source group tag info in syslogs.
- `acl_log_interval` (Number) Log update interval in seconds.
  - Range: `5`-`86400`
- `acl_log_match_log_level` (Number) Acllog logging level severity.
  - Range: `0`-`7`
- `acl_log_threshold` (Number) Number of packets are logged before the expiry of the alert interval the system generates a Syslog message.
  - Range: `0`-`1000000`
...
- `ftp_source_interfaces` (Attributes Map) List of FTP source interfaces, per VRF.
  - Map key: `vrf` - VRF. (see [below for nested schema](#nestedatt--ftp_source_interfaces))
...
- `password_encryption_admin_state` (String) The administrative state of the AES password encryption feature.
  - Choices: `enabled`, `disabled`
- `password_encryption_use_tam` (String) Use Trust Anchor Module (TAM) for password encryption.
  - Choices: `enabled`, `disabled`
- `pvlan_fex_trunk` (String) Enable or disable PVLANs for FEX trunk.
  - Choices: `enabled`, `disabled`
- `pvlan_interfaces` (Attributes Map) PVLAN port configurations.
  - Map key: `interface_id` - Interface id of port with PVLAN. Must match first field in the output of `show intf brief`. Example: `eth1/1` or `vlan100`. (see [below for nested schema](#nestedatt--pvlan_interfaces))
- `pvlan_svis` (Attributes Map) SVI configuration for propagating L3 capabilities to secondary VLANs.
  - Map key: `interface_id` - Interface id of port with PVLAN. Must match first field in the output of `show intf brief`. Example: `eth1/1` or `vlan100`. (see [below for nested schema](#nestedatt--pvlan_svis))
- `pvlans` (Attributes Map) VLAN configuration and operation for PVLAN.
  - Map key: `vlan_id` - VLAN ID in a PVLAN. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`. (see [below for nested schema](#nestedatt--pvlans))
...
- `ssh_port` (Number) SSH port.
  - Range: `22`-`65535`
- `ssh_source_interfaces` (Attributes Map) List of SSH source interfaces, per VRF.
  - Map key: `vrf` - VRF. (see [below for nested schema](#nestedatt--ssh_source_interfaces))
...
<a id="nestedatt--ftp_source_interfaces"></a>
### Nested Schema for `ftp_source_interfaces`
...
<a id="nestedatt--pvlan_interfaces"></a>
### Nested Schema for `pvlan_interfaces`

Optional:

- `access_promiscuous_primary_vlan` (String) Primary VLAN of a PVLAN domain. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`.
- `access_promiscuous_secondary_vlans` (String) Secondary VLANS of the PVLAN domain.
- `access_secondary_primary_vlan` (String) Primary VLAN of a PVLAN domain. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`.
- `access_secondary_secondary_vlan` (String) Secondary VLAN of the PVLAN domain. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`.
- `trunk_allowed_vlans` (String) Trunk Allowed VLANs on PVLAN trunk.
- `trunk_native_vlan` (String) Native VLAN on PVLAN trunk. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`.
- `trunk_promiscuous_mappings` (Attributes Map) PVLAN Promiscuous Trunk Entry.
  - Map key: `primary_vlan` - Primary VLAN of a PVLAN domain. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`. (see [below for nested schema](#nestedatt--pvlan_interfaces--trunk_promiscuous_mappings))
- `trunk_secondary_associations` (Attributes Map) PVLAN Isolated Trunk Entry.
  - Map key: `primary_vlan` - Primary VLAN of a PVLAN domain. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`. (see [below for nested schema](#nestedatt--pvlan_interfaces--trunk_secondary_associations))

<a id="nestedatt--pvlan_interfaces--trunk_promiscuous_mappings"></a>
### Nested Schema for `pvlan_interfaces.trunk_promiscuous_mappings`

Optional:

- `secondary_vlans` (String) Secondary VLANS of the PVLAN domain.


<a id="nestedatt--pvlan_interfaces--trunk_secondary_associations"></a>
### Nested Schema for `pvlan_interfaces.trunk_secondary_associations`

Optional:

- `secondary_vlan` (String) Secondary VLAN of the PVLAN domain. Possible values are `unknown`, `vlan-XX` or `vxlan-XX`.



<a id="nestedatt--pvlan_svis"></a>
### Nested Schema for `pvlan_svis`
...
<a id="nestedatt--pvlans"></a>
### Nested Schema for `pvlans`

Optional:

- `association` (String) Association of Primary VLAN to Secondary VLANs in a PVLAN.
- `type` (String) Type of VLAN in a PVLAN: Primary, Community or Isolated.
  - Choices: `isolated`, `community`, `primary`, `nonOperational`
...
- `firewall_policy_admin_state` (String) Instance in-service state.
  - Choices: `out-of-service`, `in-service`
...
<a id="nestedatt--ssh_source_interfaces"></a>
### Nested Schema for `ssh_source_interfaces`
