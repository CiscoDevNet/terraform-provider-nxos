...
func TestAccNxosPIMStaticRPPolicy(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_pim_static_rp_policy.test", "vrf_name", "default"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_pim_static_rp_policy.test", "name", "RP"))
