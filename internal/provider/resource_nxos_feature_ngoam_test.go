...
func TestAccNxosFeatureNGOAM(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_feature_ngoam.test", "admin_state", "enabled"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNxosFeatureNGOAMConfig_all(),
...
func testAccNxosFeatureNGOAMConfig_all() string {
	config := `resource "nxos_feature_ngoam" "test" {` + "\n"
	config += `	admin_state = "enabled"` + "\n"
	config += `}` + "\n"
	return config
