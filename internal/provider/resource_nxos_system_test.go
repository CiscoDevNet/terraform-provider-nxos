...
func TestAccNxosSystem(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_admin_state", "enabled"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_device_id_type", "mac"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_hold_interval", "120"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_pnp_startup_vlan", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_transmit_frequency", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_version", "v1"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_interfaces.eth1/1.admin_state", "enabled"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "cdp_interfaces.eth1/1.port_description", "My Port"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "password_encryption_admin_state", "enabled"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "password_encryption_use_tam", "disabled"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_detailed", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_entries", "8000"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_include_mac", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_include_sgt", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_interval", "300"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_match_log_level", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_system.test", "acl_log_threshold", "100"))
