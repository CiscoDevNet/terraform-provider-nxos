...
func (d *RouteMapDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the Route-Map configuration.", "rpmEntity", "Routing%20and%20Forwarding/rpm:Entity/").String,
