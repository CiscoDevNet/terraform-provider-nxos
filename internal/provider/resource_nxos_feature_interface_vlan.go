...
var _ resource.ResourceWithImportState = &FeatureInterfaceVLANResource{}
...
func (r *FeatureInterfaceVLANResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
