...
func TestAccDataSourceNxosVRFRouteTarget(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_vrf_route_target.test", "route_target", "route-target:as2-nn2:2:2"))
...
func testAccDataSourceNxosVRFRouteTargetConfig() string {
