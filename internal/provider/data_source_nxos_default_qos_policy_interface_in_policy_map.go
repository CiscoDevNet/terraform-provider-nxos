...
var _ datasource.DataSource = &DefaultQOSPolicyInterfaceInPolicyMapDataSource{}
...
func (d *DefaultQOSPolicyInterfaceInPolicyMapDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_default_qos_policy_interface_in_policy_map"
}

func (d *DefaultQOSPolicyInterfaceInPolicyMapDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *DefaultQOSPolicyInterfaceInPolicyMapDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
