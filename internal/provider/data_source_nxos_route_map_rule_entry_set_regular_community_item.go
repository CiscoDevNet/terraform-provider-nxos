...
var (
	_ datasource.DataSource              = &RouteMapRuleEntrySetRegularCommunityItemDataSource{}
	_ datasource.DataSourceWithConfigure = &RouteMapRuleEntrySetRegularCommunityItemDataSource{}
)

func NewRouteMapRuleEntrySetRegularCommunityItemDataSource() datasource.DataSource {
	return &RouteMapRuleEntrySetRegularCommunityItemDataSource{}
}
...
func (d *RouteMapRuleEntrySetRegularCommunityItemDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read a Set Community item in a Route-Map Rule Entry.", "rtregcomItem", "Routing%20and%20Forwarding/rtregcom:Item/").String,
...
func (d *RouteMapRuleEntrySetRegularCommunityItemDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config, state RouteMapRuleEntrySetRegularCommunityItem
