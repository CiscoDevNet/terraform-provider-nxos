...
var _ datasource.DataSource = &BGPPeerAddressFamilyDataSource{}
...
func (d *BGPPeerAddressFamilyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *BGPPeerAddressFamilyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
