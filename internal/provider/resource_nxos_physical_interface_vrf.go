...
var _ resource.ResourceWithImportState = &PhysicalInterfaceVRFResource{}
...
func (r *PhysicalInterfaceVRFResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
