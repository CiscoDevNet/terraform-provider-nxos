...
var (
	_ datasource.DataSource              = &BGPPeerAddressFamilyPrefixListControlDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPPeerAddressFamilyPrefixListControlDataSource{}
)

func NewBGPPeerAddressFamilyPrefixListControlDataSource() datasource.DataSource {
	return &BGPPeerAddressFamilyPrefixListControlDataSource{}
}
...
func (d *BGPPeerAddressFamilyPrefixListControlDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the BGP peer address family prefix list control configuration.", "bgpPfxCtrlP", "Routing%20and%20Forwarding/bgp:PfxCtrlP/").String,
...
func (d *BGPPeerAddressFamilyPrefixListControlDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config, state BGPPeerAddressFamilyPrefixListControl
