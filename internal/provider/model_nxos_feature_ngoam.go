...
type FeatureNGOAM struct {
	Device     types.String `tfsdk:"device"`
	Dn         types.String `tfsdk:"id"`
	AdminState types.String `tfsdk:"admin_state"`
}

type FeatureNGOAMIdentity struct {
	Device types.String `tfsdk:"device"`
}
...
func (data FeatureNGOAM) getClassName() string {
	return "fmNgoam"
}

func (data FeatureNGOAM) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureNGOAM) fromBody(res gjson.Result) {
	data.AdminState = types.StringValue(res.Get(data.getClassName() + ".attributes.adminSt").String())
}

func (data *FeatureNGOAM) updateFromBody(res gjson.Result) {
...
func (data FeatureNGOAM) toDeleteBody() nxos.Body {
	body := ""
