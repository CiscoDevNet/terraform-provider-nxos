...
type resourceNVEVNIIngressReplicationType struct{}

func (t resourceNVEVNIIngressReplicationType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t resourceNVEVNIIngressReplicationType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceNVEVNIIngressReplication{
		provider: provider,
	}, diags
}

type resourceNVEVNIIngressReplication struct {
	provider provider
}

func (r resourceNVEVNIIngressReplication) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
...
func (r resourceNVEVNIIngressReplication) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourceNVEVNIIngressReplication) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state NVEVNIIngressReplication
...
func (r resourceNVEVNIIngressReplication) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state NVEVNIIngressReplication
...
func (r resourceNVEVNIIngressReplication) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
