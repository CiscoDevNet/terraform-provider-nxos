...
type dataSourceVRFRouteTargetAddressFamilyType struct{}
...
func (t dataSourceVRFRouteTargetAddressFamilyType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceVRFRouteTargetAddressFamily{
		provider: provider,
	}, diags
}

type dataSourceVRFRouteTargetAddressFamily struct {
	provider provider
}

func (d dataSourceVRFRouteTargetAddressFamily) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var config, state VRFRouteTargetAddressFamily
