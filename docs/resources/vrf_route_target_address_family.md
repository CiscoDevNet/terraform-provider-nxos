...
description: |-
  ...
  API Documentation: rtctrlAfCtrl https://pubhub.devnetcloud.com/media/dme-docs-10-3-1/docs/Routing%20and%20Forwarding/rtctrl:AfCtrl/
  Parent resources
...
import {
  ...
  identity = {
    ...
    "route_target_address_family" : "<route_target_address_family>"
  }
}
```
