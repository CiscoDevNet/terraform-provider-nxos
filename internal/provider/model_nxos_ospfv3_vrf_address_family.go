...
func (data *OSPFv3VRFAddressFamily) getIdsFromDn() {
	reString := strings.ReplaceAll("sys/ospfv3/inst-[%s]/dom-[%s]/af-[%s]", "%[1]s", ".+")
	...
	data.AddressFamilyType = types.StringValue(matches[3])
}
