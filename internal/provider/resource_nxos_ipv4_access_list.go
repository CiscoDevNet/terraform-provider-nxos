...
type resourceIPv4AccessListType struct{}
...
func (t resourceIPv4AccessListType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceIPv4AccessList{
		provider: provider,
	}, diags
}

type resourceIPv4AccessList struct {
	provider provider
}

func (r resourceIPv4AccessList) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
...
func (r resourceIPv4AccessList) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourceIPv4AccessList) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state IPv4AccessList
...
func (r resourceIPv4AccessList) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state IPv4AccessList
...
func (r resourceIPv4AccessList) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
