...
func (d *ICMPv4DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the ICMPv4 configuration on NX-OS devices, including per-VRF and per-interface ICMP control settings such as redirects and unreachables.").AddApiDocumentation("icmpv4Entity", "ICMP/icmpv4:Entity/", []string{"icmpv4Inst", "icmpv4Dom", "icmpv4If"}, []string{"ICMP/icmpv4:Inst/", "ICMP/icmpv4:Dom/", "ICMP/icmpv4:If/"}).String,
