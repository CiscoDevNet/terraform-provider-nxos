...
var (
	_ datasource.DataSource              = &VPCPeerlinkDataSource{}
	_ datasource.DataSourceWithConfigure = &VPCPeerlinkDataSource{}
)

func NewVPCPeerlinkDataSource() datasource.DataSource {
	return &VPCPeerlinkDataSource{}
}
...
func (d *VPCPeerlinkDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read the vPC peerlink configuration.", "vpcPeerLink", "System/vpc:PeerLink/").String,
