...
var (
	_ datasource.DataSource              = &Keychain_keyDataSource{}
	_ datasource.DataSourceWithConfigure = &Keychain_keyDataSource{}
)

func NewKeychain_keyDataSource() datasource.DataSource {
	return &Keychain_keyDataSource{}
}

type Keychain_keyDataSource struct {
	data *NxosProviderData
}

func (d *Keychain_keyDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *Keychain_keyDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *Keychain_keyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config Keychain_key
