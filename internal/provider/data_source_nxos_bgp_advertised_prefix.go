...
var (
	_ datasource.DataSource              = &BGPAdvertisedPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPAdvertisedPrefixDataSource{}
)

func NewBGPAdvertisedPrefixDataSource() datasource.DataSource {
	return &BGPAdvertisedPrefixDataSource{}
}
...
func (d *BGPAdvertisedPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config BGPAdvertisedPrefix
