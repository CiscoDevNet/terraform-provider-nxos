...
type resourceVRFDomainType struct{}
...
func (t resourceVRFDomainType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"rd": {
				MarkdownDescription: helpers.NewAttributeDescription("RD value.").String,
				Type:                types.StringType,
				Optional:            true,
				Computed:            true,
			},
...
func (t resourceVRFDomainType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceVRFDomain{
		provider: provider,
	}, diags
}

type resourceVRFDomain struct {
	provider provider
}

func (r resourceVRFDomain) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state VRFDomain
...
func (r resourceVRFDomain) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state VRFDomain
...
func (r resourceVRFDomain) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state VRFDomain
...
func (r resourceVRFDomain) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state VRFDomain
...
func (r resourceVRFDomain) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
