...
type dataSourceBGPInstanceDomainAfType struct{}

func (t dataSourceBGPInstanceDomainAfType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceBGPInstanceDomainAfType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceBGPInstanceDomainAf{
		provider: provider,
	}, diags
}

type dataSourceBGPInstanceDomainAf struct {
	provider provider
}

func (d dataSourceBGPInstanceDomainAf) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var config, state BGPInstanceDomainAf
