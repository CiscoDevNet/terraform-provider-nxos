...
var (
	_ datasource.DataSource              = &OSPFAreaDataSource{}
	_ datasource.DataSourceWithConfigure = &OSPFAreaDataSource{}
)
...
func (d *OSPFAreaDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
