...
var _ datasource.DataSource = &DHCPRelayAddressDataSource{}

func NewDHCPRelayAddressDataSource() datasource.DataSource {
	return &DHCPRelayAddressDataSource{}
}
...
func (d *DHCPRelayAddressDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewResourceDescription("This data source can read a DHCP relay address.", "dhcpRelayAddr", "DHCP/dhcp:RelayAddr/").String,
...
func (d *DHCPRelayAddressDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
