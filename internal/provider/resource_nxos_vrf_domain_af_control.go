...
type resourceVRFDomainAfControlType struct{}
...
func (t resourceVRFDomainAfControlType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceVRFDomainAfControl{
		provider: provider,
	}, diags
}

type resourceVRFDomainAfControl struct {
	provider provider
}

func (r resourceVRFDomainAfControl) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state VRFDomainAfControl
...
func (r resourceVRFDomainAfControl) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state VRFDomainAfControl
...
func (r resourceVRFDomainAfControl) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state VRFDomainAfControl
...
func (r resourceVRFDomainAfControl) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state VRFDomainAfControl
...
func (r resourceVRFDomainAfControl) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
