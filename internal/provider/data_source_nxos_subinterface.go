...
var _ datasource.DataSource = &SubinterfaceDataSource{}

func NewSubinterfaceDataSource() datasource.DataSource {
	return &SubinterfaceDataSource{}
}
...
func (d *SubinterfaceDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_subinterface"
}

func (d *SubinterfaceDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *SubinterfaceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
