...
var _ resource.ResourceWithImportState = &DHCPRelayAddressResource{}
...
func (r *DHCPRelayAddressResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
