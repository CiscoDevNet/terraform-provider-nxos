...
type resourcePIMSSMRangeType struct{}
...
func (t resourcePIMSSMRangeType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourcePIMSSMRange{
		provider: provider,
	}, diags
}

type resourcePIMSSMRange struct {
	provider provider
}

func (r resourcePIMSSMRange) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
...
func (r resourcePIMSSMRange) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourcePIMSSMRange) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state PIMSSMRange
...
func (r resourcePIMSSMRange) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state PIMSSMRange
...
func (r resourcePIMSSMRange) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
