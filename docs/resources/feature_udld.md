...
description: |-
  ...
  API Documentation: fmUdld https://pubhub.devnetcloud.com/media/dme-docs-10-3-1/docs/Feature%20Management/fm:Udld/
---
...
```shell
terraform import nxos_feature_udld.example ""
```
