...
type resourceDHCPRelayAddressType struct{}
...
func (t resourceDHCPRelayAddressType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceDHCPRelayAddress{
		provider: provider,
	}, diags
}

type resourceDHCPRelayAddress struct {
	provider provider
}

func (r resourceDHCPRelayAddress) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state DHCPRelayAddress
...
func (r resourceDHCPRelayAddress) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourceDHCPRelayAddress) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state DHCPRelayAddress
...
func (r resourceDHCPRelayAddress) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state DHCPRelayAddress
...
func (r resourceDHCPRelayAddress) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
