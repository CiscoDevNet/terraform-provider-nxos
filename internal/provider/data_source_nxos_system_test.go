...
func TestAccDataSourceNxosSystem(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.nxos_system.test", "entity_extended_dme_load_interval", "300"))
...
func testAccDataSourceNxosSystemConfig() string {
	...
	config += `		}` + "\n"
	config += `	}` + "\n"
	config += `	entity_extended_dme_load_interval = 300` + "\n"
