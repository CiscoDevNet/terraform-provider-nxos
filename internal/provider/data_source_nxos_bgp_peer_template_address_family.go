...
var (
	_ datasource.DataSource              = &BGPPeerTemplateAddressFamilyDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPPeerTemplateAddressFamilyDataSource{}
)
...
func (d *BGPPeerTemplateAddressFamilyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config BGPPeerTemplateAddressFamily
