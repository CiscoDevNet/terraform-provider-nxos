...
func TestAccNxosBGPPeerAddressFamilyPrefixListControl(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_bgp_peer_address_family_prefix_list_control.test", "asn", "65001"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_bgp_peer_address_family_prefix_list_control.test", "vrf", "default"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_bgp_peer_address_family_prefix_list_control.test", "address", "192.168.0.1"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_bgp_peer_address_family_prefix_list_control.test", "address_family", "ipv4-ucast"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_bgp_peer_address_family_prefix_list_control.test", "direction", "in"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_bgp_peer_address_family_prefix_list_control.test", "list", "PREFIX_LIST1"))
