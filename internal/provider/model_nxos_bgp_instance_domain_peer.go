...
type BGPInstanceDomainPeer struct {
...
func (data BGPInstanceDomainPeer) getDn() string {
	return fmt.Sprintf("sys/bgp/inst/dom-[%s]/peer-[%s]", data.Vrf_name.Value, data.Addr.Value)
}

func (data BGPInstanceDomainPeer) getClassName() string {
	return "bgpPeer"
}

func (data BGPInstanceDomainPeer) toBody() nxos.Body {
	attrs := nxos.Body{}.
...
func (data *BGPInstanceDomainPeer) fromBody(res gjson.Result) {
...
func (data *BGPInstanceDomainPeer) fromPlan(plan BGPInstanceDomainPeer) {
