...
var _ resource.ResourceWithImportState = &NVEVNIContainerResource{}
...
func (r *NVEVNIContainerResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
