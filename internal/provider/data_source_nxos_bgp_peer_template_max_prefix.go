...
type dataSourceBGPPeerTemplateMaxPrefixType struct{}

func (t dataSourceBGPPeerTemplateMaxPrefixType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceBGPPeerTemplateMaxPrefixType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceBGPPeerTemplateMaxPrefix{
		provider: provider,
	}, diags
}

type dataSourceBGPPeerTemplateMaxPrefix struct {
	provider provider
}

func (d dataSourceBGPPeerTemplateMaxPrefix) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
