...
var _ datasource.DataSource = &FeatureHSRPDataSource{}
...
func (d *FeatureHSRPDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *FeatureHSRPDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
