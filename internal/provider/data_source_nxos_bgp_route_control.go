...
type dataSourceBGPRouteControlType struct{}

func (t dataSourceBGPRouteControlType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceBGPRouteControlType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceBGPRouteControl{
		provider: provider,
	}, diags
}

type dataSourceBGPRouteControl struct {
	provider provider
}

func (d dataSourceBGPRouteControl) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var config, state BGPRouteControl
