...
var _ datasource.DataSource = &FeatureHMMDataSource{}

func NewFeatureHMMDataSource() datasource.DataSource {
	return &FeatureHMMDataSource{}
}
...
func (d *FeatureHMMDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *FeatureHMMDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
