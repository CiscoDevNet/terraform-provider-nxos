...
type resourceBGPInstanceDomainPeerType struct{}

func (t resourceBGPInstanceDomainPeerType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewResourceDescription("This resource can manage the BGP peer configuration.", "bgpPeer", "Routing%20and%20Forwarding/bgp:Peer/").AddParents("bgp_instance_domain").AddChildren("bgp_instance_domain_peer_af").AddReferences("bgp_instance_domain_peercontainer").String,
...
func (t resourceBGPInstanceDomainPeerType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceBGPInstanceDomainPeer{
		provider: provider,
	}, diags
}

type resourceBGPInstanceDomainPeer struct {
	provider provider
}

func (r resourceBGPInstanceDomainPeer) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state BGPInstanceDomainPeer
...
func (r resourceBGPInstanceDomainPeer) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state BGPInstanceDomainPeer
...
func (r resourceBGPInstanceDomainPeer) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state BGPInstanceDomainPeer
...
func (r resourceBGPInstanceDomainPeer) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state BGPInstanceDomainPeer
...
func (r resourceBGPInstanceDomainPeer) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
