...
type FeatureInterfaceVLANIdentity struct {
	Device types.String `tfsdk:"device"`
}
...
func (data FeatureInterfaceVLAN) getDn() string {
	return "sys/fm/ifvlan"
}

func (data FeatureInterfaceVLAN) getClassName() string {
	return "fmInterfaceVlan"
}

func (data FeatureInterfaceVLAN) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureInterfaceVLAN) fromBody(res gjson.Result) {
	data.AdminState = types.StringValue(res.Get(data.getClassName() + ".attributes.adminSt").String())
}

func (data *FeatureInterfaceVLAN) updateFromBody(res gjson.Result) {
...
func (data FeatureInterfaceVLAN) toDeleteBody() nxos.Body {
	body := ""
