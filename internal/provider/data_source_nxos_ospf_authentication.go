...
var _ datasource.DataSource = &OSPFAuthenticationDataSource{}
...
func (d *OSPFAuthenticationDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
