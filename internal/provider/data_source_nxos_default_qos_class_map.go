...
var _ datasource.DataSource = &DefaultQOSClassMapDataSource{}

func NewDefaultQOSClassMapDataSource() datasource.DataSource {
	return &DefaultQOSClassMapDataSource{}
}
...
func (d *DefaultQOSClassMapDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *DefaultQOSClassMapDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
