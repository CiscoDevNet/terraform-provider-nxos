...
var _ resource.ResourceWithImportState = &DefaultQOSClassMapResource{}
...
func (r *DefaultQOSClassMapResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
