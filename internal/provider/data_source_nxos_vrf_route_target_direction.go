...
var (
	_ datasource.DataSource              = &VRFRouteTargetDirectionDataSource{}
	_ datasource.DataSourceWithConfigure = &VRFRouteTargetDirectionDataSource{}
)
...
func (d *VRFRouteTargetDirectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config VRFRouteTargetDirection
