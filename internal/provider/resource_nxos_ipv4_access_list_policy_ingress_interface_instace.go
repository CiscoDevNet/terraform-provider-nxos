...
type resourceIPv4AccessListPolicyIngressInterfaceInstaceType struct{}

func (t resourceIPv4AccessListPolicyIngressInterfaceInstaceType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t resourceIPv4AccessListPolicyIngressInterfaceInstaceType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceIPv4AccessListPolicyIngressInterfaceInstace{
		provider: provider,
	}, diags
}

type resourceIPv4AccessListPolicyIngressInterfaceInstace struct {
	provider provider
}

func (r resourceIPv4AccessListPolicyIngressInterfaceInstace) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
...
func (r resourceIPv4AccessListPolicyIngressInterfaceInstace) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
...
func (r resourceIPv4AccessListPolicyIngressInterfaceInstace) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state IPv4AccessListPolicyIngressInterfaceInstace
...
func (r resourceIPv4AccessListPolicyIngressInterfaceInstace) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state IPv4AccessListPolicyIngressInterfaceInstace
...
func (r resourceIPv4AccessListPolicyIngressInterfaceInstace) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
