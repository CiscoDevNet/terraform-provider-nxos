...
var (
	_ datasource.DataSource              = &RouteMapRuleEntryMatchRouteDataSource{}
	_ datasource.DataSourceWithConfigure = &RouteMapRuleEntryMatchRouteDataSource{}
)

func NewRouteMapRuleEntryMatchRouteDataSource() datasource.DataSource {
	return &RouteMapRuleEntryMatchRouteDataSource{}
}
...
func (d *RouteMapRuleEntryMatchRouteDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewResourceDescription("This data source can read a Match Route in Route-Map Rule Entry configuration.", "rtmapMatchRtDst", "Routing%20and%20Forwarding/rtmap:MatchRtDst/").String,
...
func (d *RouteMapRuleEntryMatchRouteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config, state RouteMapRuleEntryMatchRoute
