...
type resourceFeatureLLDPType struct{}
...
func (t resourceFeatureLLDPType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceFeatureLLDP{
		provider: provider,
	}, diags
}

type resourceFeatureLLDP struct {
	provider provider
}

func (r resourceFeatureLLDP) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan, state FeatureLLDP
...
func (r resourceFeatureLLDP) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state FeatureLLDP
...
func (r resourceFeatureLLDP) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state FeatureLLDP
...
func (r resourceFeatureLLDP) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state FeatureLLDP
...
func (r resourceFeatureLLDP) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
