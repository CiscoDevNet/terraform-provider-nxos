...
description: |-
  ...
  API Documentation: bgpDomAf https://pubhub.devnetcloud.com/media/dme-docs-10-3-1/docs/Routing%20and%20Forwarding/bgp:DomAf/
  Parent resources
...
```terraform
import {
  to = nxos_bgp_address_family.example
  identity = {
    "asn" : "<asn>"
    "vrf" : "<vrf>"
