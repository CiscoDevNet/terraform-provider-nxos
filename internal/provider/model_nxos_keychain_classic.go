...
type Keychain_classic struct {
	Device types.String `tfsdk:"device"`
	Dn     types.String `tfsdk:"id"`
	Name   types.String `tfsdk:"name"`
}

func (data Keychain_classic) getDn() string {
	return fmt.Sprintf("sys/kcmgr/keychains/classickeychain-[%s]", data.Name.ValueString())
}

func (data Keychain_classic) getClassName() string {
	return "kcmgrClassicKeychain"
}

func (data Keychain_classic) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *Keychain_classic) fromBody(res gjson.Result, all bool) {
...
func (data Keychain_classic) toDeleteBody() nxos.Body {
	body := ""

	return nxos.Body{body}
}

func (data *Keychain_classic) getIdsFromDn() {
