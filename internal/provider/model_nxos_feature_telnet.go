...
func (data FeatureTelnet) toBody(statusReplace bool) nxos.Body {
	body := ""
...
func (data *FeatureTelnet) updateFromBody(res gjson.Result) {
...
func (data FeatureTelnet) getDeleteDns() []string {
	dns := []string{}
