...
func TestAccNxosQueuingQOSPolicyMapMatchClassMapPriority(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_queuing_qos_policy_map_match_class_map_priority.test", "policy_map_name", "PM1"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_queuing_qos_policy_map_match_class_map_priority.test", "class_map_name", "c-out-q1"))
	checks = append(checks, resource.TestCheckResourceAttr("nxos_queuing_qos_policy_map_match_class_map_priority.test", "level", "1"))
