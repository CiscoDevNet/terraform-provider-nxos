...
- BREAKING CHANGE: Remove `nxos_queuing_qos_policy_map` resource and data source, `nxos_queuing_qos_policy_map_match_class_map` resource and data source, `nxos_queuing_qos_policy_map_match_class_map_priority` resource and data source, `nxos_queuing_qos_policy_map_match_class_map_remaining_bandwidth` resource and data source, `nxos_queuing_qos_policy_system_out` resource and data source, and `nxos_queuing_qos_policy_system_out_policy_map` resource and data source, queuing QoS configuration is now managed as a single `nxos_queuing_qos` resource and data source
- BREAKING CHANGE: Remove `nxos_route_map` resource and data source, `nxos_ipv4_prefix_list` resource and data source, `nxos_route_map_rule` resource and data source, `nxos_route_map_rule_entry` resource and data source, `nxos_route_map_rule_entry_match_route` resource and data source, `nxos_route_map_rule_entry_match_route_prefix_list` resource and data source, `nxos_route_map_rule_entry_match_tag` resource and data source, `nxos_route_map_rule_entry_set_regular_community` resource and data source, and `nxos_route_map_rule_entry_set_regular_community_item` resource and data source, route map and IPv4 prefix list configuration is now managed as a single `nxos_route_policy` resource and data source
...
- BREAKING CHANGE: Remove `nxos_default_qos_class_map` resource and data source, `nxos_default_qos_class_map_dscp` resource and data source, `nxos_default_qos_policy_map` resource and data source, `nxos_default_qos_policy_map_match_class_map` resource and data source, `nxos_default_qos_policy_map_match_class_map_set_qos_group` resource and data source, `nxos_default_qos_policy_map_match_class_map_police` resource and data source, `nxos_default_qos_policy_interface_in` resource and data source, and `nxos_default_qos_policy_interface_in_policy_map` resource and data source, default QoS configuration is now managed as a single `nxos_default_qos` resource and data source
...
- BREAKING CHANGE: Remove `nxos_nve_vni_container` resource and data source, `nxos_nve_vni` resource and data source, `nxos_nve_vni_ingress_replication` resource and data source, and `nxos_nve_interface` resource and data source, NVO configuration is now managed as a single `nxos_nvo` resource and data source
...
- BREAKING CHANGE: Remove `nxos_ipv4_access_list` resource and data source, `nxos_ipv4_access_list_policy_egress_interface` resource and data source, `nxos_ipv4_access_list_policy_ingress_interface` resource and data source, and `nxos_ipv4_access_lists` resource and data source, Access List configuration is now managed as a single `nxos_access_lists` resource and data source
