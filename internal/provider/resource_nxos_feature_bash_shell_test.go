...
func TestAccNxosFeatureBashShell(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("nxos_feature_bash_shell.test", "admin_state", "enabled"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNxosFeatureBashShellConfig_all(),
...
func testAccNxosFeatureBashShellConfig_all() string {
	config := `resource "nxos_feature_bash_shell" "test" {` + "\n"
	config += `	admin_state = "enabled"` + "\n"
	config += `}` + "\n"
	return config
